...
paired_with: uk-eu-food-retail-coverage.es.md
short_description: "Which grocery and food retail chains are covered in the United Kingdom and European Union, with per-chain record counts and coverage gap notes as of Phase 18."
cites: []
---
...
large-format hypermarkets in Germany, classified as a full-format hypermarket anchor.
...
but are not classified as large-format hypermarket anchors because their store
sizes fall below the full-hypermarket threshold used for T1/T2 anchor designation.
