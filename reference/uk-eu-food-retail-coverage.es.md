...
paired_with: uk-eu-food-retail-coverage.md
short_description: "Qué cadenas de supermercados y comercio minorista de alimentación están cubiertas en el Reino Unido y la UE, con conteos de registros por cadena y notas sobre brechas de cobertura a partir de la Fase 18."
cites: []
---
...
adicionales en Polonia). Kaufland opera hipermercados de línea completa, clasificado
como ancla de hipermercado de formato completo.

**Globus** (Q528681, Globus Holding) aporta 125 registros. Globus opera
hipermercados de gran formato en Alemania, clasificado como hipermercado ancla de
formato completo.
...
en OSM pero no se clasifican como hipermercados ancla de pleno formato porque sus
tamaños de tienda están por debajo del umbral de hipermercado completo utilizado
para la designación de anclas T1/T2. Contribuyen a la formación de clústeres T3
como miembros de comercio minorista general.
