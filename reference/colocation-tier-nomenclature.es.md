...
La barrera de extensión de 2,5 km se introdujo en el Cambio B (28 de mayo de 2026).
Antes del Cambio B, el nivel se determinaba únicamente por la composición de las
anclas. La barrera corrigió el hallazgo de que un subconjunto de clústeres con
composición T2 tenía valores de extensión muy superiores a los 2,5 km y
representaba distribuciones comerciales geográficamente difusas en lugar de los
patrones de colocalización compacta que definen el caso de uso del análisis de
mercado.
...
del wiki y manuscritos académicos.
...
## Recuentos por Geografía (Fase 23+Cambio B)

La plataforma cubre 6.493 clústeres en 18 países. Los clústeres T1 son más
frecuentes en Estados Unidos (889), Alemania (227) y Francia (247). Los clústeres
T2 son más frecuentes en Estados Unidos (1.779), Alemania (338) y Gran Bretaña
(400). El desglose completo por país aparece en el [resumen de colocalización](https://gis.woodfinegroup.com/research-summary.html).

---

*Procedencia de los datos:* clusters-meta.json Fase 23+Cambio B (reconstrucción
2026-05-29T05:00Z); definiciones de taxonomía de la plataforma.
