...
Informal operational agreements between team members or roles do not require a contract — a [[style-guide-memo|memo]] or [[style-guide-ticket-comment|ticket comment]] records them. Agreements that bind a legal entity (PointSav Digital Systems, MCorp, or a third party) require governance review before any signature.
