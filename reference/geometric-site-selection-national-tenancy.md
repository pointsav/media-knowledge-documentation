...
title: "Retail Anchor Co-location Composition as a Spatial Leading Indicator of Commercial Activity"
...
editor: jwoodfine
short_description: "Continental-scale framework for classifying retail anchor co-location clusters by anchor category composition across 6,493 clusters in thirteen countries. In preparation for intended submission to the Journal of Economic Geography."
paired_with: geometric-site-selection-national-tenancy.es.md
---

> **Working Draft · Version 0.4 · 2026-05-28**
> This manuscript is in preparation for intended submission to the *Journal of Economic Geography* (Oxford University Press). It has not been submitted to or reviewed by any journal. Findings are preliminary and subject to revision. Correspondence: jmwoodfine@gmail.com.
>
> **Forward-Looking Statements**
> Certain statements in this paper describe intended research directions, planned capabilities, and anticipated outcomes. These statements reflect the authors' current expectations as of the date above. Actual results and measurements may differ materially.
...
This research was conducted within the geographic analysis function of MCorp. The research design, hypotheses, and falsification programme are independent of commercial product development. The analytical dataset — 6,493 co-location clusters across thirteen countries — derives from a GIS infrastructure operated by the company. All source data (OpenStreetMap, Kontur Population, US LODES, Spain MITMA) is publicly available; the clustering methodology is fully described in §3 and is reproducible from those inputs. The analytical framework was originally developed to support site selection for commercial real estate development adjacent to established retail power centres, a use case requiring systematic identification of sub-metropolitan markets with demonstrated anchor depth. The research framework presented here generalises that application: the tier taxonomy and catchment-rank variables are agnostic to downstream use class and are presented as a geographic intelligence framework applicable across commercial real estate, urban retail planning, and economic geography.
...
<!-- DATA PENDING: §7.2 OLS regression — blocked on Phase 24B (Kontur population join + O-D data) -->
