...
title: Estándares de Tipografía y Neurodiversidad
...
- **Fuentes Nativas del Sistema:** Utilizamos fuentes integradas en el SO (como Segoe UI o Roboto) para evitar retrasos en la carga y cambios de diseño visual.
- **Alineación a la Izquierda:** El texto justificado está prohibido, ya que crea espacios irregulares que dificultan la lectura. La alineación a la izquierda garantiza un flujo visual constante.
