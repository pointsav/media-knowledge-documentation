...
previsto es desarrollar un runtime propio de PointSav en moonshot-sel4-vmm.

La ABI de seL4 es pequeña y formalmente verificada — no cambia arbitrariamente porque
las pruebas la restringen. Escribir enlaces propios (~300 líneas de Rust) lleva el mismo
tiempo que integrar una biblioteca externa, pero deja el código bajo el control de PointSav.
