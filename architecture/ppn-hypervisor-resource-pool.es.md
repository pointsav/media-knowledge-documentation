...
paired_with: ppn-hypervisor-resource-pool.md
...
1. El hipervisor (controlador de balloon) señala al controlador de balloon que se inflate en N páginas.
2. El controlador asigna esas páginas dentro del invitado, eliminándolas del espacio de direcciones utilizables del invitado.
