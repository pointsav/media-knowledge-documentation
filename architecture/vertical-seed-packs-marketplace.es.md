...
El **Mercado de Paquetes de Semilla Vertical** es un mecanismo de distribución planificado para taxonomías de inicio específicas de la industria que aprovisionan el grafo de conocimiento de un nuevo inquilino de la plataforma. Cada paquete agrupa [[archetypes-and-chart-of-accounts|Arquetipos, un Plan de Cuentas]], Dominios, Temas, un glosario y extensiones de servidor [[mcp-substrate-protocol|MCP]] adecuadas para una vertical de negocio particular. Véase [[seed-taxonomy-as-smb-bootstrap|el bootstrap de taxonomía semilla para PYMEs]].
