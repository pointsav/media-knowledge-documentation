...
- **`DOCTRINE.md`** — Foundry constitutional charter; substrate composition discipline.
- **`MANIFEST.md`** — workspace passport declaring `vault-privategit-source-1` instance identity.
- **`conventions/project-tetrad-discipline.md`** — ratified Project Tetrad specification.
- **`conventions/three-ring-architecture.md`** — Ring 1/2/3 substrate composition reference.
