...
paired_with: topic-capability-geometry.md
cites: []
---
...
## Geometría de Capacidades Definida

Geometría de Capacidades es la condición en la que el modelo de autorización es un DAG
...
| IAM / ACL Convencional | Geometría de Capacidades (seL4) |
|---|---|
...
el sustrato de capacidades en Rust. La arquitectura de tres binarios
