...
The category of attacks called lateral movement — where an attacker compromises one node and uses it to reach more valuable nodes — is the dominant pattern in modern breach reports. The Diode Standard removes it structurally.
