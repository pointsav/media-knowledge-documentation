...
- [[apprenticeship-substrate]] — the verdict-signed training mechanism
- [[four-tier-slm-substrate]] — the four-tier model routing hierarchy
- [[single-boundary-compute-discipline]] — the Doorman boundary discipline
- [[trajectory-substrate]] — the corpus capture and separation rules
