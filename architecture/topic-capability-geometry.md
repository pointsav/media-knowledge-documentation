...
slug: topic-capability-geometry
aliases:
...
paired_with: topic-capability-geometry.es.md
cites: []
---
...
Capability Geometry is the condition where the authorization model is a formally proven
...
via RFC 9162 Merkle proof chains. The F12 audit trail routes through this verdict function.
...
capability substrate above it. The three-binary architecture
