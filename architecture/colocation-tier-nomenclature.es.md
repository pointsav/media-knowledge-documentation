...
short_description: "Definiciones de los niveles T1 Regional, T2 Distrito y T3 Local de clústeres de colocalización, incluyendo reglas de composición de anclas, el algoritmo DBSCAN de dos pasadas y la barrera de extensión geométrica del Cambio B."
cites: []
---
...
TOPIC y manuscritos de investigación.
