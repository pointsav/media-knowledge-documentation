...
apex del cliente). Un cliente que recibe un binario puede reconstruir el plan a
partir de la especificación y verificar que el `plan_hash` coincide con el valor
...
*(El TOPIC canónico en inglés está en [[moonshot-toolkit-build-orchestrator]].
