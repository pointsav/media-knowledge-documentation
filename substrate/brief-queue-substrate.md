...
The Brief Queue Substrate stores events as JSONL files on a local filesystem rather than routing them through a hosted message broker. This is an intentional architectural choice grounded in the platform's [[compounding-substrate|sovereignty posture]] and operational constraints, not a limitation to be remedied later.
